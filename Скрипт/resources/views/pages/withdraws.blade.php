				...
				<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
					<div class="profile__content-wrapper">
						<div class="profile__content-header">
							...
							<a class="profile__content-header-tab" href="/profile/pays">Пополнения</a>
							<span class="profile__content-header-tab profile__content-header-tab_active">Выводы</span>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td class="table__td">Выплата на сумму {{$p->amount}} руб.</td>
											...
											@elseif($p->status == 2)
											<td class="table__td table__td_right">Отказано</td>
											@endif
										</tr>
										@endforeach
									</tbody>
